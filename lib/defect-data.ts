...
export const defectGuides: DefectGuide[] = [
  ...
  },
  {
    ...
    whyThisHappens: {
      simple: "Melt shoots out like a rope instead of spreading smoothly across the steel.",
      scientific: "A fast, unsupported melt stream cools on itself before it wets the cavity wall and bonds into the flow front.",
      misconceptions: ["Jetting is always a material problem.", "More speed will smooth out every gate mark."],
      ineffectiveFirstTries: ["Raising pack pressure after the rope mark is already formed.", "Changing every heat zone before checking the gate and first-stage speed."],
      technicianFirstLooks: ["Gate direction, gate size, and whether the mark starts at the gate.", "Initial injection speed and whether melt impinges on a wall."],
    },
    teachNewTechnician: ["Jetting starts at the gate, so start your thinking there.", "The first part of fill sets the surface pattern.", "Slow the launch before chasing pack or hold.", "A gate that shoots into open space may need tooling help."],
  },
  {
    name: "Weld Lines",
    slug: "weld-lines",
  ...
  { name: "Ejector Pin Marks", slug: "ejector-pin-marks", description: "Raised, shiny, white, or depressed circles appear where ejector pins push the part out of the mold.", causes: ["Ejection force is high because the part is sticking or too hot.", "Ejector pins are uneven, damaged, undersized, or poorly located.", "Pack pressure or cooling imbalance creates stress at pin locations."], checkFirst: ["Inspect ejector pin height, condition, location, and witness marks.", "Check cooling time, part temperature, sticking, and pack pressure."], actions: ["Correct sticking and balance ejection speed/stroke.", "Increase cooling or reduce pack if the process is overpacked.", "Repair, polish, resize, or relocate ejector pins with tooling."], processAreas: ["Ejection", "Cooling", "Pack/hold", "Tooling", "Part design"], materialChecks: ["Shrink rate", "Mold release", "Filler content", "Stress whitening tendency"] },
  {
    name: "Gate Blush",
    slug: "gate-blush",
    description: "A hazy, white, or dull halo appears around the gate from shear, stress, cold slugging, or gate freeze effects.",
    causes: ["Excessive shear through a small or restrictive gate.", "High injection speed, cold material, or cold mold near the gate.", "Gate design or vestige creates localized stress."],
    checkFirst: ["Confirm blush starts at the gate and compare gate size, temperature, and first-stage speed.", "Check material drying and colorant compatibility."],
    actions: ["Reduce initial injection speed or gate shear.", "Raise melt/mold temperature within approved limits.", "Review gate size, land, cold slug, or vestige improvements."],
    processAreas: ["Gate design", "Fill speed", "Shear", "Melt temperature", "Mold temperature"],
    materialChecks: ["Moisture", "Colorant", "Stress whitening", "Cold pellets"],
    whyThisHappens: {
      simple: "Plastic gets stressed or chilled right as it enters the cavity.",
      scientific: "High gate shear, cold material, or localized freeze-off creates orientation and stress whitening near the gate.",
      misconceptions: ["Gate blush is always wet material.", "More pack pressure will erase the halo."],
      ineffectiveFirstTries: ["Increasing hold pressure before reducing gate shear.", "Ignoring gate condition, cold slug, or first-stage speed."],
      technicianFirstLooks: ["Whether the halo begins exactly at the gate.", "Gate restriction, initial speed, melt temperature, mold temperature, and drying."],
    },
    teachNewTechnician: ["If the mark circles the gate, think gate shear first.", "Small gates can make good plastic look bad.", "Change launch speed before changing pack.", "Check cold slug and material drying before blaming color."],
  },
