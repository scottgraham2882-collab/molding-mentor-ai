...
const categoryDefinitions = [
  { title: "Start Here", purpose: "Simple first stops for people who are new, unsure, or trying to find the right next tool.", hrefs: ["/start-here", "/why-molding-mentor", "/mission", "/"] },
