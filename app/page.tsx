          ...
          <div className="mt-4 grid gap-6 lg:grid-cols-[1.5fr_1fr] lg:items-end">
            <div>
              ...
              <div className="mt-6 grid max-w-xl gap-3">
                <Link
                  href="/start-here"
                  className="flex flex-col rounded-2xl border border-cyan-200 bg-cyan-50 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-cyan-500 hover:bg-cyan-100 focus:outline-none focus:ring-4 focus:ring-cyan-200"
                >
                ...
                >
                  ...
                  <span className="mt-2 block text-xl font-black text-slate-950">Why Molding Mentor Experience</span>
                  <span className="mt-2 block text-sm leading-6 text-slate-600">See how the workspace supports people, proof, and practical shop-floor decisions.</span>
                </Link>
              </div>
            </div>
